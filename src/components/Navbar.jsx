            ...
            <div className="px-4 lg:px-8">
                ...
                <div className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div className="hidden lg:flex items-center">
                        ...
                        >
                            <button className="btn btn-ghost mx-1 xl:m-1 text-lg xl:text-xl text-white hover:bg-red-500 border-red-600 flex items-center gap-2">
                                Services
                                <ChevronDown size={20} />
                            </button>

                            {listOpen && (
                                <ul className="absolute top-full left-0 menu bg-black rounded-box z-10 w-44 p-2 shadow-lg border">
                                    <li><Link to="/services/structuredwiring" onClick={() => setListOpen(false)} className="text-white hover:bg-red-500">Structured Wiring</Link></li>
                                    <li><Link to="/services/securitysystems" onClick={() => setListOpen(false)} className="text-white hover:bg-red-500">Security Systems</Link></li>
                                    <li><Link to="/services/homeautomation" onClick={() => setListOpen(false)} className="text-white hover:bg-red-500">Home Automation</Link></li>
                                    <li><Link to="/services/intercomsystems" onClick={() => setListOpen(false)} className="text-white hover:bg-red-500">Intercom</Link></li>
                                    <li><Link to="/services/audiovideo" onClick={() => setListOpen(false)} className="text-white hover:bg-red-500">Audio & Video</Link></li>
                                    <li><Link to="/services/networking" onClick={() => setListOpen(false)} className="text-white hover:bg-red-500">Networking</Link></li>
                                    <li><Link to="/services/centralvacuum" onClick={() => setListOpen(false)} className="text-white hover:bg-red-500">Vacuum System</Link></li>
                                </ul>
                            )}
                        </div>
